...
package com.knoxpo.android.trivialdriveCheck;
...
import com.knoxpo.android.trivialdriveCheck.util.IabBroadcastReceiver;
import com.knoxpo.android.trivialdriveCheck.util.IabBroadcastReceiver.IabBroadcastListener;
import com.knoxpo.android.trivialdriveCheck.util.IabHelper;
import com.knoxpo.android.trivialdriveCheck.util.IabHelper.IabAsyncInProgressException;
import com.knoxpo.android.trivialdriveCheck.util.IabResult;
import com.knoxpo.android.trivialdriveCheck.util.Inventory;
import com.knoxpo.android.trivialdriveCheck.util.Purchase;
...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    static final String SKU_PREMIUM = "premium1";
    static final String SKU_GAS = "gas1";

    // SKU for our subscription (infinite gas)
    static final String SKU_INFINITE_GAS_MONTHLY = "auto_gas_monthly";
    static final String SKU_INFINITE_GAS_YEARLY = "auto_gas_yearly";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";
